...
public interface OAuth2SQLStorage extends OAuth2Storage, SQLStorage {
    void createOAuth2Client_Transaction(TenantIdentifier tenantIdentifier, @Nonnull String client_id, @Nonnull String name,
                                        @Nonnull String client_secret_hash, @Nonnull List<String> redirect_uris,
                                        boolean enabled, long created_at)
            throws StorageQueryException, DuplicateOAuth2ClientSecretHash, DuplicateOAuth2ClientIdException;
    OAuth2Client getOAuth2ClientByIdAndClientSecretHash_Transaction(String clientId, String clientSecretHash)
            throws StorageQueryException, UnknownOAuth2ClientIdOrSecretException;

    void addOrSetOAuth2ClientScope_Transaction(TenantIdentifier tenantIdentifier, @Nonnull String client_id,
                                               @Nonnull String scope, boolean requiresConsent)
            throws StorageQueryException, UnknownOAuth2ClientIdException, UnknownOAuth2ScopeException;

    OAuth2AuthorizationCode getOAuth2AuthorizationCodeByCodeHash_Transaction(String codeHash)
            throws StorageQueryException, UnknownOAuth2AuthorizationCodeHashException;
    void removeOAuth2AuthorizationCodeByCodeHash_Transaction(String codeHash)
            throws StorageQueryException, UnknownOAuth2AuthorizationCodeHashException;
