...
public interface PasswordlessStorage extends AuthRecipeStorage {
    ...
    void deleteDevicesByPhoneNumber(String phoneNumber) throws StorageQueryException;

    void deleteDevicesByEmail(String email) throws StorageQueryException;
    ...
    void deleteCode(String codeId) throws StorageQueryException;
